...
- __Application__ refers to SA Jobs Easy (com.sajobs.sajobseasy), the software program provided by the Company.

- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SA Jobs Easy (com.sajobs.sajobseasy).
...
- By email: sajobseasy@instruction.com
